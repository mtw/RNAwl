  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'v':	/* Verbose output.  */
          ...
          break;
        case 'n':	/* Set number of bins used for normalization.  */
