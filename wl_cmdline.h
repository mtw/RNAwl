...
struct gengetopt_args_info
{
  ...
  int norm_arg;	/**< @brief Set number of bins used for normalization.  */
  char * norm_orig;	/**< @brief Set number of bins used for normalization original value given at command line.  */
  const char *norm_help; /**< @brief Set number of bins used for normalization help description.  */
